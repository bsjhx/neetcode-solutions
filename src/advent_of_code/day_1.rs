...
mod test {
    ...
    #[test]
    fn test_replace_words_number_with_digits() {
        //     let actual = replace_words_number_with_digits("onetwothree");
        //     assert_eq!(actual, "1on2et3wothree");
        //
        //     let actual = replace_words_number_with_digits("11onetwothree");
        //     assert_eq!(actual, "111two3");
        //
        //     let actual = replace_words_number_with_digits("3two7vrv2rlqc4nine");
        //     assert_eq!(actual, "327vrv2rlqc49");
        //
        //     let actual = replace_words_number_with_digits("331s2twonep");
        //     assert_eq!(actual, "331s2tw1p");
        //
        // let actual = replace_words_number_with_digits("one");
        // assert_eq!(actual, "11one");
        // let actual = replace_words_number_with_digits("1oneninej7seven5one");
        // assert_eq!(actual, "1oneninej7seven51one");
    }
}
